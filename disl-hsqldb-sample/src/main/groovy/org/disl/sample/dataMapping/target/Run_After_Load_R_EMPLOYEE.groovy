/*
 * Copyright 2017 Antonin Krotky <antoninkrotky@gmail.com>.
 *
...
import static org.disl.sample.dataMapping.library.ExpressionLibrary.decodeSex

@DependsOn(objects = [Load_R_EMPLOYEE])
class Run_After_Load_R_EMPLOYEE extends LoadTargetTableMapping {
	...
	public void initMapping() {
		...
		where "1=0 /*just an example of dependency*/"
	}
